#!/bin/bash
#SBATCH --job-name=train_static_v2
#SBATCH --output=logs/slurm/train_static_v2_%j.out
#SBATCH --error=logs/slurm/train_static_v2_%j.err
...
echo "Environment Index: $ENV_IDX (StaticObstacleEnv-v2)"
