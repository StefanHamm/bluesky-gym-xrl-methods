...
if __name__ == "__main__":
    ...
    actionHeatmap = ActionHeatmapWrapper(env, model=model,draw_action_heatmap=True, grid_size=30, grid_spacing_km=1,export_gifs_path=gifFolder,fps=5,plot_action_path=True)
